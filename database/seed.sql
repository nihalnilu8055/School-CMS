...
(1, 'Alexander Wright', 'admin@apexacademy.edu', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 1, '+1 (555) 019-2834', '/images/staff3.jpg'),
(2, 'Sarah Jenkins', 'editor@apexacademy.edu', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 3, '+1 (555) 019-5821', '/images/staff4.jpg')
ON CONFLICT (id) DO NOTHING;
...
(1, 'Dr. Robert Vance', '/images/staff1.jpg', 'Head of Science Department', 1, 'Ph.D. in Physics (MIT)', '16 Years', 'r.vance@apexacademy.edu', '+1 (555) 101-2030', 'Passionate educator specializing in quantum mechanics, robotics, and STEM curriculum design.', 1),
(2, 'Prof. Eleanor Vance', '/images/staff2.jpg', 'Senior Math Faculty', 2, 'M.Sc. Applied Mathematics (Stanford)', '12 Years', 'e.vance@apexacademy.edu', '+1 (555) 101-2031', 'Dedicated to making complex mathematics intuitive, fun, and applicable to real-world data science.', 2),
(3, 'Dr. Marcus Sterling', '/images/staff3.jpg', 'Dean of Humanities', 3, 'Ph.D. English Literature (Oxford)', '18 Years', 'm.sterling@apexacademy.edu', '+1 (555) 101-2032', 'Author and global speaker encouraging critical thinking, public speaking, and historical analysis.', 3),
(4, 'Ms. Clara Thorne', '/images/staff4.jpg', 'Fine Arts Director', 4, 'M.F.A. Fine Arts (Rhode Island School of Design)', '9 Years', 'c.thorne@apexacademy.edu', '+1 (555) 101-2033', 'Inspiring creative expression through oil painting, digital illustration, and ceramic art.', 4),
(5, 'Coach David Miller', '/images/staff5.jpg', 'Athletics & Sports Director', 5, 'B.S. Sports Science & Physical Ed', '14 Years', 'd.miller@apexacademy.edu', '+1 (555) 101-2034', 'Former national swimmer guiding students in discipline, teamwork, and championship sportsmanship.', 5)
ON CONFLICT (id) DO NOTHING;
...
(1, 'Campus Architecture & Facilities', 'campus-architecture', '/images/campus.jpg', 'Modern classrooms, digital libraries, sports arena, and green eco-campus grounds.'),
(2, 'STEM & Robotics Exhibition', 'stem-robotics-expo', '/images/lab.jpg', 'Students presenting working prototypes and automated systems at the annual fair.'),
(3, 'Sports Meet & Athletic Championship', 'sports-meet-2026', '/images/sports.jpg', 'Action shots from track and field events, basketball finals, and swimming tournaments.')
ON CONFLICT (id) DO NOTHING;
